...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Io(e,t,n){let r=new Float32Array(So),i=new U(0,1,0);return new Pi({name:`SphericalGaussianBlur`,defines:{n:So,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:zo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Lo(){return new Pi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:zo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ro(){return new Pi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zo(),fragmentShader:`
	...
	`}var Bo=class extends kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new di([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;continue}if((u=l.match(i))&&(c.gamma=parseFloat(u[1])),(u=l.match(a))&&(c.exposure=parseFloat(u[1])),(u=l.match(o))&&(c.valid|=2,c.format=u[1]),(u=l.match(s))&&(c.valid|=4,c.height=parseInt(u[1],10),c.width=parseInt(u[2],10)),c.valid&2&&c.valid&4)break}return c.valid&2||t(3,`missing format specifier`),c.valid&4||t(3,`missing image size specifier`),c},i=function(e,n,r){let i=n;if(i<8||i>32767||e[0]!==2||e[1]!==2||e[2]&128)return new Uint8Array(e);i!==(e[2]<<8|e[3])&&t(3,`wrong scanline width`);let a=new Uint8Array(4*n*r);a.length||t(4,`unable to allocate buffer space`);let o=0,s=0,c=4*i,l=new Uint8Array(4),u=new Uint8Array(c),d=r;for(;d>0&&s<e.byteLength;){s+4>e.byteLength&&t(1),l[0]=e[s++],l[1]=e[s++],l[2]=e[s++],l[3]=e[s++],(l[0]!=2||l[1]!=2||(l[2]<<8|l[3])!=i)&&t(3,`bad rgbe scanline format`);let n=0,r;for(;n<c&&s<e.byteLength;){r=e[s++];let i=r>128;if(i&&(r-=128),(r===0||n+r>c)&&t(3,`bad scanline data`),i){let t=e[s++];for(let e=0;e<r;e++)u[n++]=t}else u.set(e.subarray(s,s+r),n),n+=r,s+=r}let f=i;for(let e=0;e<f;e++){let t=0;a[o]=u[e+t],t+=i,a[o+1]=u[e+t],t+=i,a[o+2]=u[e+t],t+=i,a[o+3]=u[e+t],o+=4}d--}return a},a=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=e[t+0]*i,n[r+1]=e[t+1]*i,n[r+2]=e[t+2]*i,n[r+3]=1},o=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=Yn.toHalfFloat(Math.min(e[t+0]*i,65504)),n[r+1]=Yn.toHalfFloat(Math.min(e[t+1]*i,65504)),n[r+2]=Yn.toHalfFloat(Math.min(e[t+2]*i,65504)),n[r+3]=Yn.toHalfFloat(1)},s=new Uint8Array(e);s.pos=0;let c=r(s),l=c.width,u=c.height,d=i(s.subarray(s.pos),l,u),f,p,m;switch(this.type){case h:m=d.length/4;let e=new Float32Array(m*4);for(let t=0;t<m;t++)a(d,t*4,e,t*4);f=e,p=h;break;case g:m=d.length/4;let t=new Uint16Array(m*4);for(let e=0;e<m;e++)o(d,e*4,t,e*4);f=t,p=g;break;default:throw Error(`THREE.HDRLoader: Unsupported type: `+this.type)}return{width:l,height:u,data:f,header:c.string,gamma:c.gamma,exposure:c.exposure,type:p}}setDataType(e){return this.type=e,this}load(e,t,n,r){function i(e,n){switch(e.type){case h:case g:e.colorSpace=Re,e.minFilter=o,e.magFilter=o,e.generateMipmaps=!1,e.flipY=!0;break}t&&t(e,n)}return super.load(e,i,n,r)}},Wp=class extends Up{constructor(e){console.warn(`RGBELoader has been deprecated. Please use HDRLoader instead.`),super(e)}},Gp=class{particles;geometry;material;maxParticles=500;positions;velocities;lifetimes;activeCount=0;constructor(e){this.geometry=new mr,this.positions=new Float32Array(this.maxParticles*3),this.velocities=new Float32Array(this.maxParticles*3),this.lifetimes=new Float32Array(this.maxParticles),this.geometry.setAttribute(`position`,new $n(this.positions,3)),this.material=new ii({color:11184810,size:.2,transparent:!0,opacity:.5,blending:2,depthWrite:!1}),this.particles=new li(this.geometry,this.material),e.add(this.particles)}emit(e,t){if(this.activeCount<this.maxParticles){let n=this.activeCount;this.positions[n*3]=e.x,this.positions[n*3+1]=e.y,this.positions[n*3+2]=e.z,this.velocities[n*3]=t.x,this.velocities[n*3+1]=t.y,this.velocities[n*3+2]=t.z,this.lifetimes[n]=1,this.activeCount++}}update(e){let t=this.geometry.getAttribute(`position`);for(let t=0;t<this.activeCount;t++){if(this.lifetimes[t]-=e,this.lifetimes[t]<=0){this.activeCount--;let e=this.activeCount;this.positions[t*3]=this.positions[e*3],this.positions[t*3+1]=this.positions[e*3+1],this.positions[t*3+2]=this.positions[e*3+2],this.velocities[t*3]=this.velocities[e*3],this.velocities[t*3+1]=this.velocities[e*3+1],this.velocities[t*3+2]=this.velocities[e*3+2],this.lifetimes[t]=this.lifetimes[e],t--;continue}this.positions[t*3]+=this.velocities[t*3]*e,this.positions[t*3+1]+=this.velocities[t*3+1]*e,this.positions[t*3+2]+=this.velocities[t*3+2]*e}t.needsUpdate=!0}},Kp=class{chassisBody;vehicle;visualBody;wheelMeshes=[];particles;cubeCamera;cubeRenderTarget;constructor(e,t,n){let r=new Wl(new Y(.9,.4,2.5));this.chassisBody=new Q({mass:800,allowSleep:!1}),this.chassisBody.addShape(r),this.chassisBody.position.copy(n),this.chassisBody.angularVelocity.set(0,0,0);let i=new Sd(`wheel`);this.vehicle=new Ed({chassisBody:this.chassisBody,indexRightAxis:0,indexUpAxis:1,indexForwardAxis:2});let a={radius:.35,directionLocal:new Y(0,-1,0),suspensionStiffness:60,suspensionRestLength:.3,frictionSlip:10.5,dampingRelaxation:2.3,dampingCompression:4.4,maxSuspensionForce:1e5,rollInfluence:.1,axleLocal:new Y(-1,0,0),chassisConnectionPointLocal:new Y(1,1,0),maxSuspensionTravel:.3};a.chassisConnectionPointLocal.set(1,0,2),this.vehicle.addWheel(a),a.chassisConnectionPointLocal.set(-1,0,2),this.vehicle.addWheel(a),a.chassisConnectionPointLocal.set(1.1,0,-2),this.vehicle.addWheel(a),a.chassisConnectionPointLocal.set(-1.1,0,-2),this.vehicle.addWheel(a),this.vehicle.addToWorld(t);let o=[];this.vehicle.wheelInfos.forEach(()=>{let e=new Q({mass:0,type:Q.KINEMATIC,collisionFilterGroup:0,material:i});o.push(e),t.addBody(e)});{let e=new Lr(new gi(1.8,.8,5),new Ii({color:65280}));e.position.y=.4,this.visualBody=new sn,this.visualBody.add(e);let t=new Lr(new gi(.5,.2,1),new Ii({color:16777215}));t.position.set(0,.3,2.8),this.visualBody.add(t)}e.add(this.visualBody);let s=new _i(a.radius,a.radius,.4,32);s.rotateZ(Math.PI/2);let l=new Ii({color:1118481});for(let t=0;t<4;t++){let t=new Lr(s,l);e.add(t),this.wheelMeshes.push(t)}this.wheelBodies=o,this.particles=new Gp(e),this.cubeRenderTarget=new Bo(128,{generateMipmaps:!0,minFilter:c}),this.cubeCamera=new Ma(.1,1e3,this.cubeRenderTarget),this.visualBody.add(this.cubeCamera),this.visualBody.traverse(e=>{e instanceof Lr&&e.material instanceof Li&&(e.material.envMap=this.cubeRenderTarget.texture)})}applyInput(e){let t=.5,n=8e3,r=1500,i=Math.abs(this.vehicle.currentVehicleSpeedKmHour),a=t;i>100&&(a=100/i*t),a<.1&&(a=.1);let o=0,s=0;e.forward&&(o=n),e.backward&&(o=-n/2),e.left&&(s=a),e.right&&(s=-a);let c=i*i*1.5;this.chassisBody.applyLocalForce(new Y(0,-c,0),new Y(0,0,0)),this.vehicle.setSteeringValue(s,0),this.vehicle.setSteeringValue(s,1),this.vehicle.applyEngineForce(o,2),this.vehicle.applyEngineForce(o,3),e.brake?(this.vehicle.setBrake(r,0),this.vehicle.setBrake(r,1),this.vehicle.setBrake(r,2),this.vehicle.setBrake(r,3)):(this.vehicle.setBrake(0,0),this.vehicle.setBrake(0,1),this.vehicle.setBrake(0,2),this.vehicle.setBrake(0,3))}syncVisuals(){this.visualBody.position.copy(this.chassisBody.position),this.visualBody.quaternion.copy(this.chassisBody.quaternion);let e=this.wheelBodies;for(let t=0;t<this.vehicle.wheelInfos.length;t++){this.vehicle.updateWheelTransform(t);let n=this.vehicle.wheelInfos[t].worldTransform;e[t]&&(e[t].position.copy(n.position),e[t].quaternion.copy(n.quaternion)),this.wheelMeshes[t].position.copy(n.position),this.wheelMeshes[t].quaternion.copy(n.quaternion)}this.particles.update(1/60)}update(e){this.applyInput(e),this.syncVisuals()}};function qp(e,t=!1){let n=e[0].index!==null,r=new Set(Object.keys(e[0].attributes)),i=new Set(Object.keys(e[0].morphAttributes)),a={},o={},s=e[0].morphTargetsRelative,c=new mr,l=0;for(let u=0;u<e.length;++u){let d=e[u],f=0;if(n!==(d.index!==null))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them.`),null;for(let e in d.attributes){if(!r.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure "`+e+`" attribute exists among all geometries, or in none of them.`),null;a[e]===void 0&&(a[e]=[]),a[e].push(d.attributes[e]),f++}if(f!==r.size)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. Make sure all geometries have the same number of attributes.`),null;if(s!==d.morphTargetsRelative)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. .morphTargetsRelative must be consistent throughout all geometries.`),null;for(let e in d.morphAttributes){if(!i.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`.  .morphAttributes must be consistent throughout all geometries.`),null;o[e]===void 0&&(o[e]=[]),o[e].push(d.morphAttributes[e])}if(t){let e;if(n)e=d.index.count;else if(d.attributes.position!==void 0)e=d.attributes.position.count;else return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. The geometry must have either an index or a position attribute`),null;c.addGroup(l,e,u),l+=e}}if(n){let t=0,n=[];for(let r=0;r<e.length;++r){let i=e[r].index;for(let e=0;e<i.count;++e)n.push(i.getX(e)+t);t+=e[r].attributes.position.count}c.setIndex(n)}for(let e in a){let t=Jp(a[e]);if(!t)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` attribute.`),null;c.setAttribute(e,t)}for(let e in o){let t=o[e][0].length;if(t===0)break;c.morphAttributes=c.morphAttributes||{},c.morphAttributes[e]=[];for(let n=0;n<t;++n){let t=[];for(let r=0;r<o[e].length;++r)t.push(o[e][r][n]);let r=Jp(t);if(!r)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` morphAttribute.`),null;c.morphAttributes[e].push(r)}}return c}function Jp(e){let t,n,r,i=-1,a=0;for(let o=0;o<e.length;++o){let s=e[o];if(t===void 0&&(t=s.array.constructor),t!==s.array.constructor)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes.`),null;if(n===void 0&&(n=s.itemSize),n!==s.itemSize)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes.`),null;if(r===void 0&&(r=s.normalized),r!==s.normalized)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes.`),null;if(i===-1&&(i=s.gpuType),i!==s.gpuType)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes.`),null;a+=s.count*n}let o=new t(a),s=new $n(o,n,r),c=0;for(let t=0;t<e.length;++t){let r=e[t];if(r.isInterleavedBufferAttribute){let e=c/n;for(let t=0,i=r.count;t<i;t++)for(let i=0;i<n;i++){let n=r.getComponent(t,i);s.setComponent(t+e,i,n)}}else o.set(r.array,c);c+=r.count*n}return i!==void 0&&(s.gpuType=i),s}var Yp=class{scene;world;trackMeshes=[];curve;constructor(e,t){this.scene=e,this.world=t,this.createTrack()}createTrack(){this.curve=new Ti([new U(0,0,0),new U(300,0,0),new U(320,0,20),new U(320,0,40),new U(300,0,60),new U(150,0,200),new U(100,0,350),new U(0,0,450),new U(-150,0,480),new U(-400,0,400),new U(-550,0,200),new U(-600,0,0),new U(-450,0,-200),new U(-150,0,-150)],!0);let t=this.curve.getSpacedPoints(400),n=new mr,r=[],i=[],a=new U(0,1,0);for(let e=0;e<t.length;e++){let n=e/(t.length-1),o=t[e],s=this.curve.getTangent(n).normalize(),c=new U().crossVectors(s,a).normalize(),l=new U().copy(o).addScaledVector(c,16/2),u=new U().copy(o).addScaledVector(c,-16/2);r.push(l.x,l.y+.1,l.z,u.x,u.y+.1,u.z),i.push(0,n*50,1,n*50)}let o=[];for(let e=0;e<t.length-1;e++){let t=e*2;o.push(t,t+1,t+2),o.push(t+1,t+3,t+2)}n.setAttribute(`position`,new $n(new Float32Array(r),3)),n.setAttribute(`uv`,new $n(new Float32Array(i),2)),n.setIndex(o),n.computeVertexNormals();let s=new ua,c=`/F1-Racing/`,l=new Lr(n,new Ii({color:3355443,map:s.load(`${c}textures/asphalt.jpg`,t=>{t.wrapS=e,t.wrapT=e,t.repeat.set(5,50)},void 0,()=>{console.warn(`Asphalt texture not found at`,`${c}textures/asphalt.jpg`)}),roughness:.9}));l.receiveShadow=!0,this.scene.add(l);let u=new Q({mass:0,shape:new Xd});u.quaternion.setFromEuler(-Math.PI/2,0,0),this.world.addBody(u),this.createOptimizedCurbs(t,16),this.createOptimizedBarriers(t,16),this.spawnOptimizedTrees(),this.createStartFinishVisuals(),this.spawnOptimizedBanners(),this.createGround()}createGround(){let t=new ua,n=new Ei(5e3,5e3),r=new Ii({color:1717018,roughness:1});t.load(`/F1-Racing/textures/grass.jpg`,t=>{t.wrapS=e,t.wrapT=e,t.repeat.set(500,500),r.map=t});let i=new Lr(n,r);i.rotation.x=-Math.PI/2,i.receiveShadow=!0,this.scene.add(i)}createOptimizedCurbs(e,t){let n=new U(0,1,0),r=1.2,i=new gi(r,.2,4),a=[],o=[];for(let s=0;s<e.length-1;s+=2){let c=s/(e.length-1),l=e[s],u=this.curve.getTangentAt(c).normalize(),d=new U().crossVectors(u,n).normalize(),f=s%8<4;[1,-1].forEach(e=>{let n=i.clone(),s=l.clone().addScaledVector(d,e*(t/2+r/2)),c=new on;c.position.copy(s),c.lookAt(s.clone().add(u)),c.updateMatrix(),n.applyMatrix4(c.matrix),f?a.push(n):o.push(n)})}if(a.length>0){let e=qp(a);this.scene.add(new Lr(e,new Ii({color:16711680,roughness:.8})))}if(o.length>0){let e=qp(o);this.scene.add(new Lr(e,new Ii({color:16777215,roughness:.8})))}}createOptimizedBarriers(e,t){let n=1.6,r=[],i=new gi(1,n,.5);for(let a=0;a<e.length;a+=2){let o=a/(e.length-1),s=e[a],c=e[(a+1)%e.length],l=s.distanceTo(c)*2,u=this.curve.getTangentAt(o).normalize(),d=new U().crossVectors(u,new U(0,1,0)).normalize();[1,-1].forEach(e=>{let a=s.clone().addScaledVector(d,e*(t/2+.5)),o=i.clone();o.scale(l+.1,1,1);let f=new on;f.position.copy(a),f.position.y=n/2,f.lookAt(c.clone().addScaledVector(d,e*(t/2+.5))),f.rotateY(Math.PI/2),f.updateMatrix(),o.applyMatrix4(f.matrix),r.push(o);let p=new Wl(new Y(.25,n/2,l/2)),m=new Q({mass:0});m.addShape(p),m.position.set(a.x,n/2,a.z);let h=new ut;h.setFromUnitVectors(new U(0,0,1),u),m.quaternion.set(h.x,h.y,h.z,h.w),this.world.addBody(m)})}let a=new Lr(qp(r),new Ii({color:4473924}));a.receiveShadow=!0,this.scene.add(a)}spawnOptimizedTrees(){let e=new _i(.2,.3,2),t=new Ii({color:4005663}),n=new vi(1.5,4,6),r=new Ii({color:1715738}),i=new Yr(e,t,200),a=new Yr(n,r,200);i.castShadow=!0,a.castShadow=!0;let o=new on;for(let e=0;e<200;e++){let t=Math.random(),n=this.curve.getPointAt(t),r=this.curve.getTangentAt(t).normalize(),s=new U().crossVectors(r,new U(0,1,0)).normalize(),c=Math.random()>.5?1:-1,l=18+Math.random()*25,u=n.clone().addScaledVector(s,c*l);o.position.copy(u),o.position.y=1,o.scale.setScalar(.8+Math.random()*.4),o.updateMatrix(),i.setMatrixAt(e,o.matrix),o.position.y=4,o.updateMatrix(),a.setMatrixAt(e,o.matrix)}this.scene.add(i,a)}spawnOptimizedBanners(){let e=new gi(10,3,.2),t=[16721920,61695,16777215];for(let n=0;n<3;n++){let r=new Yr(e,new Ii({color:t[n]}),5),i=0,a=new on;for(let e=0;e<15;e++){if(e%3!==n)continue;let t=e/15,o=this.curve.getPointAt(t),s=this.curve.getTangentAt(t).normalize(),c=new U().crossVectors(s,new U(0,1,0)).normalize(),l=e%2==0?1:-1,u=o.clone().addScaledVector(c,l*12);a.position.copy(u),a.position.y=2,a.lookAt(o),a.updateMatrix(),r.setMatrixAt(i++,a.matrix)}this.scene.add(r)}}createStartFinishVisuals(){let e=this.curve.getPointAt(0),t=this.curve.getTangentAt(0).normalize();new U().crossVectors(t,new U(0,1,0)).normalize();let n=document.createElement(`canvas`);n.width=128,n.height=32;let r=n.getContext(`2d`);r.fillStyle=`white`,r.fillRect(0,0,128,32),r.fillStyle=`black`;for(let e=0;e<8;e++)for(let t=0;t<2;t++)(e+t)%2==0&&r.fillRect(e*16,t*16,16,16);let i=new fi(n),a=new Lr(new Ei(16,2),new Ii({map:i,transparent:!0,opacity:.8}));a.position.copy(e).add(new U(0,.15,0)),a.rotation.x=-Math.PI/2;let o=Math.atan2(t.x,t.z);a.rotation.z=o+Math.PI/2,this.scene.add(a);let s=new sn,c=new Ii({color:2236962}),l=new Lr(new gi(1,1,19),c);l.position.y=8;let u=new Lr(new _i(.3,.4,8),c);u.position.set(0,4,9.5);let d=u.clone();d.position.set(0,4,-9.5),s.add(l,u,d),s.position.copy(e),s.lookAt(e.clone().add(t)),this.scene.add(s)}},Xp=class{forward=!1;backward=!1;left=!1;right=!1;brake=!1;constructor(){window.addEventListener(`keydown`,this.onKeyDown.bind(this)),window.addEventListener(`keyup`,this.onKeyUp.bind(this))}handleKey(e,t,n){n&&([`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`,`KeyW`,`KeyA`,`KeyS`,`KeyD`,`Space`].includes(e)||[`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`,`w`,`a`,`s`,`d`,` `,`W`,`A`,`S`,`D`].includes(n.key))&&n.preventDefault();let r=e===`KeyW`||n&&n.key===`w`||n&&n.key===`W`,i=e===`KeyS`||n&&n.key===`s`||n&&n.key===`S`,a=e===`KeyA`||n&&n.key===`a`||n&&n.key===`A`,o=e===`KeyD`||n&&n.key===`d`||n&&n.key===`D`,s=e===`ArrowUp`||n&&n.key===`ArrowUp`,c=e===`ArrowDown`||n&&n.key===`ArrowDown`,l=e===`ArrowLeft`||n&&n.key===`ArrowLeft`,u=e===`ArrowRight`||n&&n.key===`ArrowRight`,d=e===`Space`||n&&n.key===` `;s||r?this.forward=t:(c||i)&&(this.backward=t),l||a?this.left=t:(u||o)&&(this.right=t),d&&(this.brake=t)}onKeyDown(e){this.handleKey(e.code,!0,e)}onKeyUp(e){this.handleKey(e.code,!1,e)}setForward(e){this.forward=e}setBackward(e){this.backward=e}setLeft(e){this.left=e}setRight(e){this.right=e}setBrake(e){this.brake=e}},Zp=class{car;track;raceManager;progress=0;aiInput;constructor(e,t,n){this.car=e,this.track=t,this.raceManager=n,this.aiInput={forward:!1,backward:!1,left:!1,right:!1,brake:!1}}update(){this.progress=this.raceManager.getCarProgress(this.car);let e=this.car.visualBody.position,t=this.track.curve,n=(this.progress+.02)%1,r=t.getPointAt(n),i=new U(0,0,1).applyQuaternion(this.car.visualBody.quaternion),a=new U().subVectors(r,e).normalize(),o=i.angleTo(a),s=new U().crossVectors(i,a);this.aiInput.left=!1,this.aiInput.right=!1,this.aiInput.forward=!1,this.aiInput.brake=!1,o>.05&&(s.y>0?this.aiInput.left=!0:this.aiInput.right=!0);let c=this.car.chassisBody.velocity.length()*3.6,l=t.getTangentAt(n),u=t.getTangentAt((n+.01)%1),d=l.angleTo(u)*100,f=280;d>.5&&(f=150),d>1.5&&(f=80),c<f?this.aiInput.forward=!0:c>f+20&&(this.aiInput.brake=!0),this.car.update(this.aiInput)}},Qp=class{cars;track;carData;positions=[];constructor(e,t,n){this.cars=e,this.track=t,this.carData=new Map,this.cars.forEach(e=>{this.carData.set(e,{lap:1,lastU:0,totalU:0,isPlayer:e===n})})}update(){this.cars.forEach(e=>{let t=this.carData.get(e),n=this.findClosestULocal(e.visualBody.position,t.lastU);t.lastU>.8&&n<.2?t.lap++:t.lastU<.2&&n>.8&&t.lap--,t.totalU=t.lap-1+n,t.lastU=n}),this.positions=this.cars.map(e=>{let t=this.carData.get(e);return{car:e,lap:t.lap,progress:t.lastU,totalDistance:t.totalU,position:0,isPlayer:t.isPlayer}}).sort((e,t)=>t.totalDistance-e.totalDistance),this.positions.forEach((e,t)=>{e.position=t+1}),this.updateHUD()}findClosestULocal(e,t){let n=t,r=1/0,i=.1;for(let a=0;a<=50;a++){let o=(t-i/2+a/50*i+1)%1,s=this.track.curve.getPointAt(o).distanceToSquared(e);s<r&&(r=s,n=o)}return n}getCarProgress(e){return this.carData.get(e)?.lastU||0}updateHUD(){}},$p={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},em=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},tm=new wa(-1,1,1,-1,0,1),nm=new class extends mr{constructor(){super(),this.setAttribute(`position`,new nr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new nr([0,2,0,0,2,0],2))}},rm=class{constructor(e){this._mesh=new Lr(nm,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,tm)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},im=class extends em{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Pi?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=ji.clone(e.uniforms),this.material=new Pi({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new rm(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},am=class extends em{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},om=class extends em{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},sm=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new H);this._width=n.width,this._height=n.height,t=new kt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:g}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new im($p),this.copyPass.material.blending=0,this.timer=new Pa}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}am!==void 0&&(r instanceof am?n=!0:r instanceof om&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new H);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},cm=class extends em{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new K}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},lm=class{composer=null;renderer;scene;camera;useComposer=!1;constructor(e,t,n){if(this.renderer=e,this.scene=t,this.camera=n,!/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))try{this.composer=new sm(e);let r=new cm(t,n);this.composer.addPass(r),this.useComposer=!0}catch(e){console.warn(`PostProcess init failed, falling back to direct render:`,e),this.useComposer=!1}}render(){this.useComposer&&this.composer?this.composer.render():this.renderer.render(this.scene,this.camera)}setSize(e,t){this.composer&&this.composer.setSize(e,t)}},um=class{listener;engineSound;audioContext;oscillator;gain;constructor(e,t){this.listener=new Va,e.add(this.listener),this.engineSound=new qa(this.listener),t.add(this.engineSound),this.audioContext=new(window.AudioContext||window.webkitAudioContext),this.oscillator=this.audioContext.createOscillator(),this.oscillator.type=`sawtooth`,this.gain=this.audioContext.createGain(),this.gain.gain.value=0,this.oscillator.connect(this.gain),this.gain.connect(this.audioContext.destination),this.oscillator.start()}update(e){if(this.audioContext.state===`suspended`)return;let t=50+e/350*350;this.oscillator.frequency.setTargetAtTime(t,this.audioContext.currentTime,.1);let n=.1+e/350*.4;this.gain.gain.setTargetAtTime(n,this.audioContext.currentTime,.1)}async resume(){this.audioContext.state===`suspended`&&await this.audioContext.resume()}},dm=class{scene;camera;renderer;physicsWorld;car;aiCars=[];raceManager;track;postProcess;soundManager;rgbeLoader;isMobile;gameStarted=!1;lastTime=0;constructor(){this.scene=new hn,this.camera=new Ca(75,window.innerWidth/window.innerHeight,.1,2e3),this.renderer=new Cl({antialias:!0,powerPreference:`high-performance`}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1,this.isMobile=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);let e=this.isMobile?Math.min(window.devicePixelRatio,1.5):Math.min(window.devicePixelRatio,2);this.renderer.setPixelRatio(e),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=1,document.getElementById(`app`)?.appendChild(this.renderer.domElement),this.renderer.domElement.style.touchAction=`none`,this.renderer.domElement.setAttribute(`tabindex`,`0`),this.physicsWorld=new Dp,this.physicsWorld.gravity.set(0,-9.81,0);let t=new Sd(`default`),n=new xd(t,t,{friction:1,restitution:.1,contactEquationStiffness:1e9,contactEquationRelaxation:3});this.physicsWorld.addContactMaterial(n),this.physicsWorld.defaultContactMaterial=n,this.setupLighting(),this.track=new Yp(this.scene,this.physicsWorld),this.input=new Xp,this.setupMobileControls(),this.car=new Kp(this.scene,this.physicsWorld,new Y(0,1,0)),this.car.chassisBody.quaternion.setFromEuler(0,Math.PI/2,0),this.raceManager=new Qp([this.car],this.track,this.car);for(let e=0;e<3;e++){let t=-25-e*15,n=e%2==0?4:-4,r=new Kp(this.scene,this.physicsWorld,new Y(t,1,n));r.chassisBody.quaternion.setFromEuler(0,Math.PI/2,0),this.raceManager.cars.push(r);let i=new Zp(r,this.track,this.raceManager);this.aiCars.push({car:r,controller:i})}this.postProcess=new lm(this.renderer,this.scene,this.camera),this.soundManager=new um(this.camera,this.car.visualBody),document.getElementById(`start-button`)?.addEventListener(`click`,()=>{this.gameStarted=!0,this.lastTime=performance.now(),this.soundManager.resume().catch(console.error),window.focus(),this.renderer.domElement.focus(),document.getElementById(`start-menu`).style.display=`none`;let e=document.getElementById(`mobile-controls`);e&&(e.style.display=`grid`)}),window.addEventListener(`resize`,this.onWindowResize.bind(this)),window.addEventListener(`orientationchange`,()=>{setTimeout(()=>this.onWindowResize(),300)}),this.animate()}input;setupLighting(){let e=new Da(16777215,.4);this.scene.add(e);let t=new Ea(16777215,1);t.position.set(100,100,50),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,t.shadow.camera.left=-500,t.shadow.camera.right=500,t.shadow.camera.top=500,t.shadow.camera.bottom=-500,t.shadow.camera.far=1e3,this.scene.add(t),this.dirLight=t;let n=new jo(this.renderer);n.compileEquirectangularShader(),this.rgbeLoader=new Wp,this.rgbeLoader.load(`/F1-Racing/textures/env.hdr`,e=>{e.mapping=303,this.scene.environment=e,this.scene.background=e,n.dispose()})}setupMobileControls(){let e=(e,t)=>{let n=document.getElementById(e);n&&(n.addEventListener(`pointerdown`,e=>{e.preventDefault(),e.target.setPointerCapture(e.pointerId),t(!0),n.classList.add(`pressed`)}),n.addEventListener(`pointerup`,e=>{e.preventDefault(),t(!1),n.classList.remove(`pressed`)}),n.addEventListener(`pointercancel`,e=>{e.preventDefault(),t(!1),n.classList.remove(`pressed`)}))};e(`ctrl-left`,e=>this.input.setLeft(e)),e(`ctrl-right`,e=>this.input.setRight(e)),e(`ctrl-accel`,e=>this.input.setForward(e)),e(`ctrl-brake`,e=>this.input.setBrake(e)),(this.isMobile||window.matchMedia(`(pointer: coarse)`).matches)&&document.getElementById(`mobile-controls`)?.classList.add(`active`)}updateCamera(){let e=this.car.visualBody.position,t=this.car.visualBody.quaternion,n=Math.abs(this.car.vehicle.currentVehicleSpeedKmHour),r=new U(0,3.5,-12);r.applyQuaternion(t),this.camera.position.lerp(e.clone().add(r),.1),this.camera.fov=65+n/350*25,this.camera.updateProjectionMatrix();let i=new U(0,.5,8).applyQuaternion(t);this.camera.lookAt(e.clone().add(i));let a=this.dirLight;a&&(a.position.copy(e).add(new U(100,100,50)),a.target.position.copy(e),a.target.updateMatrixWorld())}onWindowResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight),this.postProcess.setSize(window.innerWidth,window.innerHeight)}animate(){if(requestAnimationFrame(this.animate.bind(this)),!this.gameStarted){this.updateCamera(),this.postProcess.render();return}this.car.applyInput(this.input);let e=performance.now(),t=Math.min((e-this.lastTime)/1e3,.1);this.lastTime=e,this.physicsWorld.step(1/60,t,10),this.car.syncVisuals(),this.raceManager.update(),this.aiCars.forEach(e=>e.controller.update()),this.updateCamera(),Math.floor(e/16)%2==0&&(this.car.visualBody.visible=!1,this.car.cubeCamera.update(this.renderer,this.scene),this.car.visualBody.visible=!0);let n=this.car.chassisBody.velocity.length()*3.6;this.soundManager.update(n),this.postProcess.render()}};window.addEventListener(`error`,e=>{let t=document.createElement(`div`);t.style.cssText=`position:fixed;top:0;left:0;right:0;background:red;color:white;padding:20px;z-index:9999;font-size:14px;word-break:break-all;`,t.textContent=`⚠️ Error: `+e.message,document.body.appendChild(t)});try{new dm}catch(e){let t=document.createElement(`div`);t.style.cssText=`position:fixed;top:0;left:0;right:0;background:red;color:white;padding:20px;z-index:9999;`,t.textContent=`Runtime Exception: `+e,document.body.appendChild(t)}