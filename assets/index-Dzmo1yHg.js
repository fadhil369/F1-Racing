...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ws(e,t,n){let r=new Float32Array(As),i=new W(0,1,0);return new Ha({name:`SphericalGaussianBlur`,defines:{n:As,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:qs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Gs(){return new Ha({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:qs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ks(){return new Ha({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qs(),fragmentShader:`
	...
	`}var Js=class extends Ot{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new ui([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},uh=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},dh=new No(-1,1,1,-1,0,1),fh=new class extends mr{constructor(){super(),this.setAttribute(`position`,new nr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new nr([0,2,0,0,2,0],2))}},ph=class{constructor(e){this._mesh=new J(fh,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,dh)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},mh=class extends uh{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Ha?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=za.clone(e.uniforms),this.material=new Ha({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new ph(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},hh=class extends uh{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},gh=class extends uh{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},_h=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new U);this._width=n.width,this._height=n.height,t=new Ot(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:g}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new mh(lh),this.copyPass.material.blending=0,this.timer=new Uo}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}hh!==void 0&&(r instanceof hh?n=!0:r instanceof gh&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new U);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},vh=class extends uh{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new q}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},yh={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new q(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};bh.BlurDirectionX=new U(1,0),bh.BlurDirectionY=new U(0,1);var xh={name:`SMAAEdgesShader`,defines:{SMAA_THRESHOLD:`0.1`},uniforms:{tDiffuse:{value:null},resolution:{value:new U(1/1024,1/512)}},vertexShader:`
		...
		}`},Sh={name:`SMAAWeightsShader`,defines:{SMAA_MAX_SEARCH_STEPS:`8`,SMAA_AREATEX_MAX_DISTANCE:`16`,SMAA_AREATEX_PIXEL_SIZE:`( 1.0 / vec2( 160.0, 560.0 ) )`,SMAA_AREATEX_SUBTEX_SIZE:`( 1.0 / 7.0 )`},uniforms:{tDiffuse:{value:null},tArea:{value:null},tSearch:{value:null},resolution:{value:new U(1/1024,1/512)}},vertexShader:`
		...
		}`},Ch={name:`SMAABlendShader`,uniforms:{tDiffuse:{value:null},tColor:{value:null},resolution:{value:new U(1/1024,1/512)}},vertexShader:`
...
`;continue}if((u=l.match(i))&&(c.gamma=parseFloat(u[1])),(u=l.match(a))&&(c.exposure=parseFloat(u[1])),(u=l.match(o))&&(c.valid|=2,c.format=u[1]),(u=l.match(s))&&(c.valid|=4,c.height=parseInt(u[1],10),c.width=parseInt(u[2],10)),c.valid&2&&c.valid&4)break}return c.valid&2||t(3,`missing format specifier`),c.valid&4||t(3,`missing image size specifier`),c},i=function(e,n,r){let i=n;if(i<8||i>32767||e[0]!==2||e[1]!==2||e[2]&128)return new Uint8Array(e);i!==(e[2]<<8|e[3])&&t(3,`wrong scanline width`);let a=new Uint8Array(4*n*r);a.length||t(4,`unable to allocate buffer space`);let o=0,s=0,c=4*i,l=new Uint8Array(4),u=new Uint8Array(c),d=r;for(;d>0&&s<e.byteLength;){s+4>e.byteLength&&t(1),l[0]=e[s++],l[1]=e[s++],l[2]=e[s++],l[3]=e[s++],(l[0]!=2||l[1]!=2||(l[2]<<8|l[3])!=i)&&t(3,`bad rgbe scanline format`);let n=0,r;for(;n<c&&s<e.byteLength;){r=e[s++];let i=r>128;if(i&&(r-=128),(r===0||n+r>c)&&t(3,`bad scanline data`),i){let t=e[s++];for(let e=0;e<r;e++)u[n++]=t}else u.set(e.subarray(s,s+r),n),n+=r,s+=r}let f=i;for(let e=0;e<f;e++){let t=0;a[o]=u[e+t],t+=i,a[o+1]=u[e+t],t+=i,a[o+2]=u[e+t],t+=i,a[o+3]=u[e+t],o+=4}d--}return a},a=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=e[t+0]*i,n[r+1]=e[t+1]*i,n[r+2]=e[t+2]*i,n[r+3]=1},o=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=Yn.toHalfFloat(Math.min(e[t+0]*i,65504)),n[r+1]=Yn.toHalfFloat(Math.min(e[t+1]*i,65504)),n[r+2]=Yn.toHalfFloat(Math.min(e[t+2]*i,65504)),n[r+3]=Yn.toHalfFloat(1)},s=new Uint8Array(e);s.pos=0;let c=r(s),l=c.width,u=c.height,d=i(s.subarray(s.pos),l,u),f,p,m;switch(this.type){case h:m=d.length/4;let e=new Float32Array(m*4);for(let t=0;t<m;t++)a(d,t*4,e,t*4);f=e,p=h;break;case g:m=d.length/4;let t=new Uint16Array(m*4);for(let e=0;e<m;e++)o(d,e*4,t,e*4);f=t,p=g;break;default:throw Error(`THREE.HDRLoader: Unsupported type: `+this.type)}return{width:l,height:u,data:f,header:c.string,gamma:c.gamma,exposure:c.exposure,type:p}}setDataType(e){return this.type=e,this}load(e,t,n,r){function i(e,n){switch(e.type){case h:case g:e.colorSpace=Le,e.minFilter=o,e.magFilter=o,e.generateMipmaps=!1,e.flipY=!0;break}t&&t(e,n)}return super.load(e,i,n,r)}},Oh=class extends Dh{constructor(e){console.warn(`RGBELoader has been deprecated. Please use HDRLoader instead.`),super(e)}};new class{renderer;scene;camera;physicsWorld;input;car;aiCars=[];raceManager;track;postProcess;soundManager;gameStarted=!1;lastTime=0;constructor(){this.lastTime=performance.now(),this.scene=new hn,this.scene.background=new q(8900331),this.scene.fog=new mn(8900331,20,300),this.camera=new Mo(60,window.innerWidth/window.innerHeight,.1,1e3),this.renderer=new ju({antialias:!0,powerPreference:`high-performance`}),this.renderer.setSize(window.innerWidth,window.innerHeight);let e=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)?Math.min(window.devicePixelRatio,2):window.devicePixelRatio;this.renderer.setPixelRatio(e),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=2,document.getElementById(`app`)?.appendChild(this.renderer.domElement),this.physicsWorld=new Rm({gravity:new Z(0,-9.81,0)});let t=new Mf(`default`),n=new jf(t,t,{friction:.7,restitution:.2,contactEquationStiffness:1e8,contactEquationRelaxation:3});this.physicsWorld.addContactMaterial(n),this.physicsWorld.defaultContactMaterial=n,this.setupLighting(),this.track=new oh(this.scene,this.physicsWorld),this.input=new eh,this.setupMobileControls(),this.car=new rh(this.scene,this.physicsWorld,new Z(-10,2,0)),this.car.chassisBody.quaternion.setFromEuler(0,Math.PI/2,0),this.raceManager=new ch([this.car],this.track,this.car);let r=[65280,255,16776960];for(let e=0;e<3;e++){let t=-25-e*15,n=e%2==0?4:-4,i=new rh(this.scene,this.physicsWorld,new Z(t,2,n));i.chassisBody.quaternion.setFromEuler(0,Math.PI/2,0),i.visualBody.traverse(t=>{t instanceof J&&t.material instanceof Ga&&(t.material=t.material.clone(),t.material.color.set(r[e]))});let a=new sh(i,this.track,this.raceManager);this.aiCars.push({car:i,controller:a}),this.raceManager.cars.push(i),this.raceManager.carData.set(i,{lap:1,lastU:0,totalU:0,isPlayer:!1})}this.postProcess=new Th(this.renderer,this.scene,this.camera),this.soundManager=new Eh(this.camera,this.car.visualBody),document.getElementById(`start-button`)?.addEventListener(`click`,()=>{this.gameStarted=!0,this.lastTime=performance.now(),this.soundManager.resume(),window.focus(),this.renderer.domElement.focus(),document.getElementById(`start-menu`).style.display=`none`,document.getElementById(`game-ui`).style.display=`flex`}),window.addEventListener(`resize`,this.onWindowResize.bind(this)),this.animate()}setupMobileControls(){let e=(e,t)=>{let n=document.getElementById(e);if(!n)return;let r=(e,n)=>{e.preventDefault(),t(n)};n.addEventListener(`pointerdown`,e=>r(e,!0)),n.addEventListener(`pointerup`,e=>r(e,!1)),n.addEventListener(`pointerleave`,e=>r(e,!1))};e(`ctrl-left`,e=>this.input.setLeft(e)),e(`ctrl-right`,e=>this.input.setRight(e)),e(`ctrl-accel`,e=>this.input.setForward(e)),e(`ctrl-brake`,e=>this.input.setBrake(e))}setupLighting(){let e=new Io(16777215,.6);this.scene.add(e);let t=new Fo(16777215,1.5);t.position.set(100,100,50),t.castShadow=!0,t.shadow.mapSize.width=2048,t.shadow.mapSize.height=2048,t.shadow.camera.near=.5,t.shadow.camera.far=500,t.shadow.camera.left=-50,t.shadow.camera.right=50,t.shadow.camera.top=50,t.shadow.camera.bottom=-50,this.scene.add(t),this.dirLight=t;let n=new zs(this.renderer);n.compileEquirectangularShader(),new Oh().load(`/textures/env.hdr`,e=>{let t=n.fromEquirectangular(e).texture;this.scene.environment=t,this.scene.background=t,e.dispose(),n.dispose()})}updateCamera(){let e=this.car.visualBody.position,t=this.car.visualBody.quaternion,n=Math.abs(this.car.vehicle.currentVehicleSpeedKmHour),r=new W(0,3.5,12);r.applyQuaternion(t);let i=e.clone().add(r);this.camera.position.lerp(i,.1),this.camera.fov=60+n/350*25,this.camera.updateProjectionMatrix();let a=new W(0,0,-10).applyQuaternion(t);this.camera.lookAt(e.clone().add(a));let o=this.dirLight;o.position.copy(e).add(new W(100,100,50)),o.target.position.copy(e),o.target.updateMatrixWorld()}onWindowResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight),this.postProcess.setSize(window.innerWidth,window.innerHeight)}animate(){if(requestAnimationFrame(this.animate.bind(this)),!this.gameStarted){this.updateCamera(),this.postProcess.render();return}this.car.update(this.input);let e=performance.now(),t=(e-this.lastTime)/1e3;this.lastTime=e,this.physicsWorld.step(1/60,t,10),this.raceManager.update(),this.aiCars.forEach(e=>e.controller.update()),this.updateCamera(),Math.floor(Date.now()/16)%2==0&&(this.car.visualBody.visible=!1,this.car.cubeCamera.update(this.renderer,this.scene),this.car.visualBody.visible=!0);let n=this.car.chassisBody.velocity.length()*3.6;this.soundManager.update(n),this.postProcess.render()}};